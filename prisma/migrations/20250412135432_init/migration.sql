...
-- CreateIndex
CREATE UNIQUE INDEX "recover_passwords_token_key" ON "recover_passwords"("token");

-- CreateIndex
CREATE UNIQUE INDEX "recover_passwords_userId_key" ON "recover_passwords"("userId");
...
-- AddForeignKey
ALTER TABLE "recover_passwords" ADD CONSTRAINT "recover_passwords_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
